...
export const HONORS = [
  ...
  { id: 'astral',          cat: 'conquest', icon: 'gem',    bounty: 75, name: 'Ascendant',            desc: 'Conquer the hidden Astral Throne.' },
  ...
  { id: 'forge_godforged', cat: 'mastery',  icon: 'flame',  bounty: 60, name: 'Godsmith',             desc: 'Forge a Godforged item — the ceiling.' },
];
