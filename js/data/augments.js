...
export const AUGMENTS = {
  ...
  warchest:   { name: 'War Chest', icon: '💰', tier: 'common', cat: 'econ', desc: '+2 gold every round.', econ: { goldPerRound: 2 } },
  usurer:     { name: "Usurer's Ledger", icon: '🏦', tier: 'common', cat: 'econ', desc: 'Interest cap +3 (save up to 80g).', econ: { interestCap: 3 } },
  spyglass:   { name: 'Spyglass', icon: '🔭', tier: 'common', cat: 'econ', desc: 'One free shop reroll each planning phase.', econ: { freeRerolls: 1 } },
  scholar:    { name: "Scholar's Tome", icon: '📜', tier: 'common', cat: 'econ', desc: '+3 XP every round.', econ: { xpPerRound: 3 } },
  whetstone:  { name: 'Whetstone', icon: '🪨', tier: 'common', cat: 'combat', desc: 'Your team: +14% Attack Damage.', combat: { ad: 0.14 } },
  bulwark:    { name: 'Bulwark', icon: '🧱', tier: 'common', cat: 'combat', desc: 'Your team: +16% max Health.', combat: { hp: 0.16 } },
  grimoire:   { name: 'Shared Grimoire', icon: '📖', tier: 'common', cat: 'combat', desc: 'Your team: +35 Ability Power.', combat: { ap: 35 } },
  swiftboots: { name: 'Swift Boots', icon: '🥾', tier: 'common', cat: 'combat', desc: 'Your team: +12% Attack Speed.', combat: { as: 0.12 } },
  ironhide:   { name: 'Ironhide Totem', icon: '🪖', tier: 'common', cat: 'combat', desc: 'Your team: +22 Armor & Magic Resist.', combat: { armor: 22, mr: 22 } },
  aegis:      { name: 'Aegis Charm', icon: '🔰', tier: 'common', cat: 'combat', desc: 'Your team starts each fight with a 180 shield.', combat: { shield: 180 } },
  vampiric:   { name: 'Vampiric Sigil', icon: '🩸', tier: 'common', cat: 'combat', desc: 'Your team heals 12% of attack damage dealt.', combat: { vamp: 0.12 } },
  ...
  assassins_edge: { name: "Assassin's Edge", icon: '🗡️', tier: 'rare', cat: 'synergy', desc: 'Your Assassins gain +25% crit chance and +60% crit damage.', cond: [{ match: { klass: 'assassin' }, mods: { critChance: 0.25, critDmg: 0.6 } }], wantTrait: 'assassin' },
  pack_fury:      { name: 'Pack Fury', icon: '🐾', tier: 'rare', cat: 'synergy', desc: 'Your Beasts gain +22% Attack Damage.', cond: [{ match: { origin: 'beast' }, mods: { ad: 0.22 } }], wantTrait: 'beast' },
