...
export const AUGMENTS = {
  ...
  grimoire:   { name: 'Shared Grimoire', icon: 'wand', tier: 'common', cat: 'combat', desc: 'Your team: +50 Ability Power.', combat: { ap: 50 } },
  swiftboots: { name: 'Swift Boots', icon: 'boots', tier: 'common', cat: 'combat', desc: 'Your team: +12% Attack Speed.', combat: { as: 0.12 } },
  ironhide:   { name: 'Ironhide Totem', icon: 'shield', tier: 'common', cat: 'combat', desc: 'Your team: +16 Armor & Magic Resist.', combat: { armor: 16, mr: 16 } },
  ...
  knights_vow:    { name: "Knight's Vow", icon: 'shield', tier: 'rare', cat: 'synergy', desc: 'Your Knights gain +30 Armor & Magic Resist.', cond: [{ match: { klass: 'knight' }, mods: { armor: 30, mr: 30 } }], wantTrait: 'knight' },
  ...
  backline_barrage:{ name: 'Backline Barrage', icon: 'bow', tier: 'rare', cat: 'combat', desc: 'Back-row champions: +13% Attack Speed and +6% AD.', cond: [{ match: { row: 'back' }, mods: { as: 0.13, ad: 0.06 } }] },
  frontline_wall: { name: 'Frontline Wall', icon: 'wall', tier: 'rare', cat: 'combat', desc: 'Front-row champions: +22% Health and +22 Armor.', cond: [{ match: { row: 'front' }, mods: { hp: 0.22, armor: 22 } }] },
  ...
  battle_standard:{ name: 'Battle Standard', icon: 'banner', tier: 'rare', cat: 'combat', desc: 'Your team: +12% Attack Damage and +5% Attack Speed.', combat: { ad: 0.12, as: 0.05 } },
  ...
  arcane_overflow:{ name: 'Arcane Overflow', icon: 'wand', tier: 'prismatic', cat: 'build', desc: 'Your team: +180 Ability Power, but −10% max Health.', combat: { ap: 180, hp: -0.10 } },
  berserkers_pact:{ name: "Berserker's Pact", icon: 'axe', tier: 'prismatic', cat: 'build', desc: '+38% AD and +16% Attack Speed, but −28% max Health.', combat: { ad: 0.38, as: 0.16, hp: -0.28 } },
  titans_resolve: { name: "Titan's Resolve", icon: 'shield', tier: 'prismatic', cat: 'build', desc: '+24% max Health and +16 Armor/MR, but −15% Attack Speed.', combat: { hp: 0.24, armor: 16, mr: 16, as: -0.15 } },
  ...
  thornmail:      { name: 'Thornmail Aura', icon: 'thorns', tier: 'prismatic', cat: 'build', desc: 'Your team reflects 14% of attack damage taken and +14 Armor, but −12% Attack Damage.', combat: { thorns: 0.14, armor: 14, ad: -0.12 } },
};
