...
export const TRAITS = {
  ...
  undead: {
    ...
    breakpoints: [2, 4, 6],
    bonuses: { 2: { revivePct: 0.38 }, 4: { revivePct: 0.58 }, 6: { revivePct: 0.78 } },
    bonusText: { 2: 'Revive once at 38% HP', 4: 'at 58% HP', 6: 'at 78% HP' },
  },
  elf: {
  ...
  demon: {
    ...
    breakpoints: [2, 4, 6],
    bonuses: { 2: { burn: 38, manaBurn: 8 }, 4: { burn: 62, manaBurn: 14 }, 6: { burn: 96, manaBurn: 22 } },
    bonusText: { 2: '+38 magic dmg & −8 enemy mana per hit', 4: '+62 magic dmg & −14 enemy mana per hit', 6: '+96 magic dmg & −22 enemy mana per hit' },
  },
  beast: {
    name: 'Beast', axis: 'origin', kind: 'behaviour', color: '#ffb15a',
    desc: 'Beasts grow more ferocious as the fight drags on.',
    breakpoints: [2, 4, 6],
    bonuses: { 2: { ferocity: 0.11 }, 4: { ferocity: 0.17 }, 6: { ferocity: 0.24 } },
    bonusText: { 2: '+11% atk speed per strike', 4: '+17%', 6: '+24% (whole team)' },
  },
  dragon: {
  ...
  knight: {
    ...
    breakpoints: [2, 4, 6],
    bonuses: { 2: { block: 18 }, 4: { block: 34 }, 6: { block: 60 } },
    bonusText: { 2: 'Ignore 18 dmg/hit', 4: 'ignore 34', 6: 'ignore 60' },
  },
  mage: {
    name: 'Mage', axis: 'class', kind: 'glue', color: '#c79bff',
    desc: 'Channelled power amplifies all spell damage.',
    breakpoints: [2, 4, 6],
    bonuses: { 2: { ap: 30 }, 4: { ap: 85 }, 6: { ap: 150 } },
    bonusText: { 2: '+30 ability power', 4: '+85 AP', 6: '+150 AP' },
  },
  ranger: {
    name: 'Ranger', axis: 'class', kind: 'behaviour', color: '#9be86a',
    desc: 'Rangers loose bursts of rapid fire.',
    breakpoints: [2, 4],
    bonuses: { 2: { rangerAS: 0.20 }, 4: { rangerAS: 0.40 } },
    bonusText: { 2: '20% chance: +atk speed burst', 4: '40% chance' },
  },
  assassin: {
  ...
  summoner: {
    ...
    breakpoints: [2, 4],
    bonuses: { 2: { summonPower: 0.50 }, 4: { summonPower: 0.95 } },
    bonusText: { 2: '+50% summon HP/dmg', 4: '+95% summon HP/dmg' },
  },
};
